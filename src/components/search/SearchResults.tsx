    ...
    <div>
      ...
      <div className="flex items-center justify-between mb-4">
        <p className="text-sm text-gray-500">
          Showing <span className="font-medium">{Math.min(results.length, limit)}</span> of{" "}
          <span className="font-medium">{total}</span> results for "<span className="font-medium">{query}</span>"
        </p>
      </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex flex-wrap items-center gap-4 mt-2 text-sm">
                  ...
                  {result.type === "review" && result.rating && result.rating > 0 && (
                    <span className="flex items-center gap-1 text-gray-500">
                      <Star className="h-4 w-4 fill-yellow-400 text-yellow-400" />
