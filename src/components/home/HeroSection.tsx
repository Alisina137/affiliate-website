...
export function HeroSection() {
  ...
  return (
    <section className="relative overflow-hidden bg-linear-to-br from-blue-600 via-indigo-700 to-purple-800 text-white">
      {/* Background Pattern */}
      ...
      <div className="relative container mx-auto px-4 py-20 md:py-28">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="animate-fade-in-up-delay-2 text-xl md:text-2xl text-blue-100 mb-10 max-w-2xl mx-auto">
            Discover honest reviews, side-by-side comparisons, and expert buying
            guides to make informed decisions.
          </p>

          {/* Search Bar */}
          <form
            onSubmit={handleSearch}
            className="animate-fade-in-up-delay-3 max-w-2xl mx-auto mb-8"
          >
