...
import { Users, Shield, Star, TrendingUp, Award } from "lucide-react";
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="bg-white rounded-lg shadow-sm border p-8 mb-8">
          ...
          <p className="text-gray-600 leading-relaxed">
            Our mission is to help consumers make informed purchasing decisions
            by providing honest, thorough, and unbiased product reviews,
            comparisons, and buying guides. We believe that everyone deserves
            access to reliable information to find the best products for their
            needs.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">
                  We always disclose affiliate relationships and provide honest
                  opinions.
                </p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <Star className="h-6 w-6 text-yellow-500  shrink-0 mt-1" />
              <div>
                <h3 className="font-semibold">Quality Content</h3>
                <p className="text-sm text-gray-500">
                  We create in-depth, well-researched content that helps you
                  make decisions.
                </p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">
                  Everything we do is designed to help our users find the best
                  products.
                </p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <TrendingUp className="h-6 w-6 text-purple-600  shrink-0 mt-1" />
              <div>
                <h3 className="font-semibold">Continuous Improvement</h3>
                <p className="text-sm text-gray-500">
                  We constantly update our content to provide the most current
                  information.
                </p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              ...
              <p className="text-sm text-blue-700">
                Our team tests and reviews products thoroughly.
              </p>
            </div>
            <div>
              ...
              <p className="text-sm text-blue-700">
                We provide honest opinions, not influenced by brands.
              </p>
            </div>
            <div>
              <h3 className="font-semibold text-blue-800">
              ...
              <p className="text-sm text-blue-700">
                We regularly update our content to reflect the latest products.
              </p>
            </div>
          </div>
        </div>
